...
const Workspaces = ({ visible, items }: WorkspacesProps) => {
    ...
    return (
        <>
            <div className="mb-6">
                <Disclosure defaultOpen={true}>
                    ...
                    >
                        ...
                        {!visible && (
                            <>
                                <div className="ml-5">Workspaces</div>
                                <Icon
                ...
                >
                    <div className="ml-6 flex items-center">
                        <Icon
                            ...
                            name="plus-circle"
                        />
                        {!visible && <div className="text-sm">New workspace</div>}
                    </div>
                </button>
            </div>
            <Modal
            ...
            >
                <AddWorkspace onCancel={() => setVisibleModal(false)} />
            </Modal>
        </>
    );
};
