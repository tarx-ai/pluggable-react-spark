    ...
    return (
        <div className="max-w-[50rem]">
            ...
            <div className="-mt-8 flex items-end pl-6">
                <div
                    className={`relative shrink-0 w-16 h-16 mr-auto bg-accent-2 rounded-2xl overflow-hidden flex items-center justify-center ${
                        !loading &&
                        "shadow-[0_0_0_0.25rem_#FEFEFE] dark:shadow-[0_0_0_0.25rem_#232627]"
                    }`}
                >
                    <span className="text-n-1 font-bold text-xl">T</span>
                </div>
                {loading ? (
