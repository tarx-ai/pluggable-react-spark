    ...
    return (
        <>
            <div className="relative z-10 mr-8 lg:mr-6 md:static">
                <Menu>
                    <Menu.Button className="group relative w-10 h-10 bg-primary-1 rounded-full transition-shadow ui-open:shadow-[0_0_0_0.25rem_#0084FF] flex items-center justify-center">
                        <span className="text-n-1 font-bold text-sm">TT</span>
                    ...
                    >
                        <Menu.Items className="absolute top-full -right-5 w-[19.88rem] mt-[0.9375rem] p-4 bg-n-1 border border-n-2 rounded-2xl shadow-[0px_48px_64px_-16px_rgba(0,0,0,0.25)] md:-right-38 md:w-[calc(100vw-4rem)] dark:bg-n-7 dark:border-n-5">
                            <div className="flex items-center mb-3">
                                <div className="relative w-15 h-15 bg-primary-1 rounded-full flex items-center justify-center">
                                    <span className="text-n-1 font-bold text-xl">TT</span>
