...
const Question = ({ content, image, document, time }: QuestionProps) => (
    <div className="max-w-[50rem] ml-auto">
        ...
        <div className="-mt-8 flex items-end pr-6">
            ...
            <div className="relative w-16 h-16 ml-auto bg-primary-1 rounded-2xl overflow-hidden shadow-[0_0_0_0.25rem_#FEFEFE] dark:shadow-[0_0_0_0.25rem_#232627] flex items-center justify-center">
                <span className="text-n-1 font-bold">JD</span>
            </div>
        </div>
    </div>
);
